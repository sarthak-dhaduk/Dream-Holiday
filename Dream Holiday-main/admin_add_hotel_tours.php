          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="post">
                ...
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label">ADD One More</label>
                  <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary" name="btn_hotel_details_a"><b>+</b></button>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary" name="btn_hotel_details">Submit Form</button>
                  </div>
                </div>
<?php
if(isset($_POST['btn_hotel_details'])){
  ...
  if($id!="" || $tour_n_e!="" || $city_n_e!="" || $hotel_n_e!=""){
  $q6="INSERT INTO hotel_details (no, tourname, city, hotel, night, reach_date)VALUES('$id', '$tour_n_e', '$city_n_e', '$hotel_n_e', '$night_e', '$reach_d_e')";
...
elseif(isset($_POST['btn_hotel_details_a'])){
...
$result=mysqli_query($con,$q6);
    ...
    if($result)
      {
          header("location:admin_add_hotel_tours.php");
      }
  }
}
?>
